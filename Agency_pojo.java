...
public class Agency_pojo {
	...
	public String toString() {
		String output = "Agency_id: " + getAgency_id() + " - Agency_name: " + getAgency_name() + " - Agency_url:"
				+ getAgency_url() + " - Agency_timezone: " + getAgency_timezone() + " - Agency_lang:" + getAgency_lang()
				+ " - Agency_phone:" + getAgency_phone();
		return output;
	}
